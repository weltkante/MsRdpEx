...
namespace MSTSCLib.Legacy
{
    ...
    public interface IMsTscAx : IMsTscAx_Redist
    {
        ...
        #endregion
        #region IMsTscAx
        [DispId(1)] string Server { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(2)] string Domain { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(3)] string UserName { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(4)] string DisconnectedText { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(5)] string ConnectingText { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        ...
        [DispId(19)] string FullScreenTitle { [param: MarshalAs(UnmanagedType.BStr)] set; }
        [DispId(20)] int CipherStrength { get; }
        [DispId(21)] string Version { [return: MarshalAs(UnmanagedType.BStr)] get; }
        ...
        [DispId(33)] void CreateVirtualChannels([MarshalAs(UnmanagedType.BStr)] string newVal);
        [DispId(34)] void SendOnVirtualChannel([MarshalAs(UnmanagedType.BStr)] string chanName, [MarshalAs(UnmanagedType.BStr)] string ChanData);
        #endregion
    }
    [ComImport]
    ...
    public interface IMsTscSecuredSettings
    {
        ...
        [DispId(1)] string StartProgram { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(2)] string WorkDir { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
    ...
    public interface IMsTscAdvancedSettings
    {
        ...
        [DispId(162)] string KeyBoardLayoutStr { [param: MarshalAs(UnmanagedType.BStr)] set; }
        [DispId(170)] string PluginDlls { [param: MarshalAs(UnmanagedType.BStr)] set; }
        [DispId(171)] string IconFile { [param: MarshalAs(UnmanagedType.BStr)] set; }
    ...
    public interface IMsTscDebug
    {
        ...
        [DispId(209)] string CLXCmdLine { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(210)] string CLXDll { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
    ...
    public interface IMsTscAxEvents
    {
        ...
        [PreserveSig] [DispId(7)] void OnChannelReceivedData([MarshalAs(UnmanagedType.BStr)] string chanName, [MarshalAs(UnmanagedType.BStr)] string data);
        ...
        [PreserveSig] [DispId(16)] void OnReceivedTSPublicKey([MarshalAs(UnmanagedType.BStr)] string publicKey, out bool pfContinueLogon);
        ...
        [PreserveSig] [DispId(20)] void OnRemoteProgramResult([MarshalAs(UnmanagedType.BStr)] string bstrRemoteProgram, RemoteProgramResult lError, bool vbIsExecutable);
        ...
        [PreserveSig] [DispId(24)] void OnUserNameAcquired([MarshalAs(UnmanagedType.BStr)] string bstrUserName);
        [PreserveSig] [DispId(26)] void OnMouseInputModeChanged(bool fMouseModeRelative);
        [PreserveSig] [DispId(28)] void OnServiceMessageReceived([MarshalAs(UnmanagedType.BStr)] string serviceMessage);
    ...
    public interface IMsRdpClient : IMsTscAx
    {
        ...
        #endregion
        #region IMsTscAx
        [DispId(1)] new string Server { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(2)] new string Domain { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(3)] new string UserName { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(4)] new string DisconnectedText { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(5)] new string ConnectingText { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        ...
        [DispId(19)] new string FullScreenTitle { [param: MarshalAs(UnmanagedType.BStr)] set; }
        [DispId(20)] new int CipherStrength { get; }
        [DispId(21)] new string Version { [return: MarshalAs(UnmanagedType.BStr)] get; }
        ...
        [DispId(33)] new void CreateVirtualChannels([MarshalAs(UnmanagedType.BStr)] string newVal);
        [DispId(34)] new void SendOnVirtualChannel([MarshalAs(UnmanagedType.BStr)] string chanName, [MarshalAs(UnmanagedType.BStr)] string ChanData);
        #endregion
        #region IMsRdpClient
        ...
        [DispId(35)] void SetVirtualChannelOptions([MarshalAs(UnmanagedType.BStr)] string chanName, int chanOptions);
        [DispId(36)] int GetVirtualChannelOptions([MarshalAs(UnmanagedType.BStr)] string chanName);
    ...
    public interface IMsRdpClientAdvancedSettings : IMsTscAdvancedSettings
    {
        ...
        [DispId(162)] new string KeyBoardLayoutStr { [param: MarshalAs(UnmanagedType.BStr)] set; }
        [DispId(170)] new string PluginDlls { [param: MarshalAs(UnmanagedType.BStr)] set; }
        [DispId(171)] new string IconFile { [param: MarshalAs(UnmanagedType.BStr)] set; }
        ...
        [DispId(138)] string PersistCacheDirectory { [param: MarshalAs(UnmanagedType.BStr)] set; }
        ...
        [DispId(185)] string RdpdrLocalPrintingDocName { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(201)] string RdpdrClipCleanTempDirString { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(202)] string RdpdrClipPasteInfoString { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(186)] string ClearTextPassword { [param: MarshalAs(UnmanagedType.BStr)] set; }
        ...
        [DispId(190)] string LoadBalanceInfo { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
    ...
    {
        #region IMsTscSecuredSettings
        [DispId(1)] new string StartProgram { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(2)] new string WorkDir { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
    ...
    public interface IMsTscNonScriptable
    {
        ...
        [DispId(1)] string ClearTextPassword { [param: MarshalAs(UnmanagedType.BStr)] set; }
        [DispId(2)] string PortablePassword { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(3)] string PortableSalt { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(4)] string BinaryPassword { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(5)] string BinarySalt { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        void ResetPassword();
        #endregion
    }
    [ComImport]
    ...
    {
        #region IMsTscNonScriptable
        [DispId(1)] new string ClearTextPassword { [param: MarshalAs(UnmanagedType.BStr)] set; }
        [DispId(2)] new string PortablePassword { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(3)] new string PortableSalt { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(4)] new string BinaryPassword { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(5)] new string BinarySalt { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
    ...
    public interface IMsRdpClient2 : IMsRdpClient
    {
        ...
        [DispId(35)] new void SetVirtualChannelOptions([MarshalAs(UnmanagedType.BStr)] string chanName, int chanOptions);
        [DispId(36)] new int GetVirtualChannelOptions([MarshalAs(UnmanagedType.BStr)] string chanName);
        ...
        [DispId(201)] string ConnectedStatusText { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        #endregion
    }
    [ComImport]
    ...
    public interface IMsRdpClientAdvancedSettings2 : IMsRdpClientAdvancedSettings
    {
        ...
        [DispId(138)] new string PersistCacheDirectory { [param: MarshalAs(UnmanagedType.BStr)] set; }
        ...
        [DispId(185)] new string RdpdrLocalPrintingDocName { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(201)] new string RdpdrClipCleanTempDirString { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(202)] new string RdpdrClipPasteInfoString { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(186)] new string ClearTextPassword { [param: MarshalAs(UnmanagedType.BStr)] set; }
        ...
        [DispId(190)] new string LoadBalanceInfo { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
    ...
    public interface IMsRdpClient3 : IMsRdpClient2
    {
        ...
        [DispId(201)] new string ConnectedStatusText { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        #endregion
    ...
    public interface IMsRdpClient5 : IMsRdpClient4
    {
        ...
        [DispId(503)] [return: MarshalAs(UnmanagedType.BStr)] string GetErrorDescription(uint disconnectReason, uint ExtendedDisconnectReason);
    ...
    public interface IMsRdpClientTransportSettings
    {
        ...
        [DispId(210)] string GatewayHostname { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
    ...
    public interface IMsRdpClientShell
    {
        ...
        [DispId(202)] string RdpFileContents { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(203)] void SetRdpProperty([MarshalAs(UnmanagedType.BStr)] string szProperty, [MarshalAs(UnmanagedType.Struct)] object Value);
        [DispId(204)] [return: MarshalAs(UnmanagedType.Struct)] object GetRdpProperty([MarshalAs(UnmanagedType.BStr)] string szProperty);
    ...
    public interface IMsRdpClientNonScriptable3 : IMsRdpClientNonScriptable2
    {
        ...
        [DispId(24)] string ConnectionBarText { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        #endregion
    }
    [ComImport]
    ...
    public interface IMsRdpDeviceCollection
    {
        ...
        IMsRdpDevice get_DeviceById([MarshalAs(UnmanagedType.BStr)] string devInstanceId);
    ...
    public interface IMsRdpClient6 : IMsRdpClient5
    {
        ...
        [DispId(503)] [return: MarshalAs(UnmanagedType.BStr)] new string GetErrorDescription(uint disconnectReason, uint ExtendedDisconnectReason);
    ...
    public interface IMsRdpClientAdvancedSettings6 : IMsRdpClientAdvancedSettings5
    {
        ...
        [DispId(222)] string AuthenticationServiceClass { [return: MarshalAs(UnmanagedType.BStr)] get; [param: MarshalAs(UnmanagedType.BStr)] set; }
        [DispId(223)] string PCB { [return: MarshalAs(UnmanagedType.BStr)] get; [param: MarshalAs(UnmanagedType.BStr)] set; }
    ...
    {
        #region IMsRdpClientTransportSettings
        [DispId(210)] new string GatewayHostname { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        ...
        [DispId(218)] string GatewayPreAuthServerAddr { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(219)] string GatewaySupportUrl { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(220)] string GatewayEncryptedOtpCookie { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(221)] uint GatewayEncryptedOtpCookieSize { set; get; }
        [DispId(223)] string GatewayUsername { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(224)] string GatewayDomain { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(225)] string GatewayPassword { [param: MarshalAs(UnmanagedType.BStr)] set; }
        #endregion
    }
    [ComImport]
    ...
    public interface IMsRdpClientNonScriptable4 : IMsRdpClientNonScriptable3
    {
        ...
        [DispId(24)] new string ConnectionBarText { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        #endregion
    ...
    public interface IMsRdpClient7 : IMsRdpClient6
    {
        ...
        [DispId(602)] [return: MarshalAs(UnmanagedType.BStr)] string GetStatusText(uint statusCode);
    ...
    public interface IMsRdpClientAdvancedSettings7 : IMsRdpClientAdvancedSettings6
    {
        ...
        [DispId(222)] new string AuthenticationServiceClass { [return: MarshalAs(UnmanagedType.BStr)] get; [param: MarshalAs(UnmanagedType.BStr)] set; }
        [DispId(223)] new string PCB { [return: MarshalAs(UnmanagedType.BStr)] get; [param: MarshalAs(UnmanagedType.BStr)] set; }
    ...
    public interface IMsRdpClientTransportSettings3 : IMsRdpClientTransportSettings2
    {
        ...
        [DispId(218)] new string GatewayPreAuthServerAddr { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(219)] new string GatewaySupportUrl { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(220)] new string GatewayEncryptedOtpCookie { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(221)] new uint GatewayEncryptedOtpCookieSize { set; get; }
        [DispId(223)] new string GatewayUsername { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(224)] new string GatewayDomain { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(225)] new string GatewayPassword { [param: MarshalAs(UnmanagedType.BStr)] set; }
        #endregion
        #region IMsRdpClientTransportSettings3
        [DispId(226)] uint GatewayCredSourceCookie { set; get; }
        [DispId(227)] string GatewayAuthCookieServerAddr { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(228)] string GatewayEncryptedAuthCookie { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(229)] uint GatewayEncryptedAuthCookieSize { set; get; }
        [DispId(230)] string GatewayAuthLoginPage { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        #endregion
    }
    [ComImport]
    ...
    public interface IMsRdpClientSecuredSettings2 : IMsRdpClientSecuredSettings
    {
        ...
        [DispId(6)] string PCB { [return: MarshalAs(UnmanagedType.BStr)] get; [param: MarshalAs(UnmanagedType.BStr)] set; }
        #endregion
    }
    [ComImport]
    ...
    public interface ITSRemoteProgram2 : ITSRemoteProgram
    {
        ...
        [DispId(202)] string RemoteApplicationName { [param: MarshalAs(UnmanagedType.BStr)] set; }
        [DispId(203)] string RemoteApplicationProgram { [param: MarshalAs(UnmanagedType.BStr)] set; }
        [DispId(204)] string RemoteApplicationArgs { [param: MarshalAs(UnmanagedType.BStr)] set; }
        #endregion
    }
    [ComImport]
    ...
    public interface IMsRdpClient8 : IMsRdpClient7
    {
        ...
        [DispId(602)] [return: MarshalAs(UnmanagedType.BStr)] new string GetStatusText(uint statusCode);
    ...
    public interface IMsRdpClient9 : IMsRdpClient8
    {
        ...
        [DispId(803)] void attachEvent([MarshalAs(UnmanagedType.BStr)] string eventName, [MarshalAs(UnmanagedType.IDispatch)] object callback);
        [DispId(804)] void detachEvent([MarshalAs(UnmanagedType.BStr)] string eventName, [MarshalAs(UnmanagedType.IDispatch)] object callback);
        #endregion
    }
    [ComImport]
    ...
    public interface IMsRdpClientTransportSettings4 : IMsRdpClientTransportSettings3
    {
        ...
        [DispId(227)] new string GatewayAuthCookieServerAddr { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(228)] new string GatewayEncryptedAuthCookie { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(229)] new uint GatewayEncryptedAuthCookieSize { set; get; }
        [DispId(230)] new string GatewayAuthLoginPage { [param: MarshalAs(UnmanagedType.BStr)] set; [return: MarshalAs(UnmanagedType.BStr)] get; }
        #endregion
    ...
    public interface IMsRdpClient10 : IMsRdpClient9
    {
        ...
        [DispId(803)] new void attachEvent([MarshalAs(UnmanagedType.BStr)] string eventName, [MarshalAs(UnmanagedType.IDispatch)] object callback);
        [DispId(804)] new void detachEvent([MarshalAs(UnmanagedType.BStr)] string eventName, [MarshalAs(UnmanagedType.IDispatch)] object callback);
        #endregion
    ...
    public interface ITSRemoteProgram3 : ITSRemoteProgram2
    {
        ...
        #endregion
        #region ITSRemoteProgram2
        [DispId(202)] new string RemoteApplicationName { [param: MarshalAs(UnmanagedType.BStr)] set; }
        [DispId(203)] new string RemoteApplicationProgram { [param: MarshalAs(UnmanagedType.BStr)] set; }
        [DispId(204)] new string RemoteApplicationArgs { [param: MarshalAs(UnmanagedType.BStr)] set; }
        #endregion
        #region ITSRemoteProgram3
        [DispId(205)] void ServerStartApp([MarshalAs(UnmanagedType.BStr)] string bstrAppUserModelId, [MarshalAs(UnmanagedType.BStr)] string bstrArguments, bool vbExpandEnvVarInArgumentsOnServer);
        #endregion
    }
    [ComImport]
    ...
    public interface IMsRdpCameraRedirConfigCollection
    {
        ...
        IMsRdpCameraRedirConfig get_BySymbolicLink([MarshalAs(UnmanagedType.BStr)] string SymbolicLink);
        IMsRdpCameraRedirConfig get_ByInstanceId([MarshalAs(UnmanagedType.BStr)] string InstanceId);
    ...
    public interface IRemoteDesktopClient
    {
        ...
        [DispId(704)] void DeleteSavedCredentials([MarshalAs(UnmanagedType.BStr)] string serverName);
        [DispId(705)] void UpdateSessionDisplaySettings(uint width, uint height);
        [DispId(706)] void attachEvent([MarshalAs(UnmanagedType.BStr)] string eventName, [MarshalAs(UnmanagedType.IDispatch)] object callback);
        [DispId(707)] void detachEvent([MarshalAs(UnmanagedType.BStr)] string eventName, [MarshalAs(UnmanagedType.IDispatch)] object callback);
        #endregion
    }
    [ComImport]
    ...
    public interface IRemoteDesktopClientSettings
    {
        ...
        [DispId(722)] void ApplySettings([MarshalAs(UnmanagedType.BStr)] string RdpFileContents);
        [DispId(723)] [return: MarshalAs(UnmanagedType.BStr)] string RetrieveSettings();
        [DispId(721)] [return: MarshalAs(UnmanagedType.Struct)] object GetRdpProperty([MarshalAs(UnmanagedType.BStr)] string propertyName);
        [DispId(720)] void SetRdpProperty([MarshalAs(UnmanagedType.BStr)] string propertyName, [MarshalAs(UnmanagedType.Struct)] object Value);
        #endregion
    }
    [ComImport]
    ...
    public interface IRemoteDesktopClientActions
    {
        ...
        [DispId(733)] [return: MarshalAs(UnmanagedType.BStr)] string GetSnapshot(SnapshotEncodingType snapshotEncoding, SnapshotFormatType snapshotFormat, uint snapshotWidth, uint snapshotHeight);
        #endregion
    }
    [ComImport]
    ...
    public interface IRemoteDesktopClientEvents
    {
        ...
        [PreserveSig] [DispId(753)] void OnDisconnected(int disconnectReason, int ExtendedDisconnectReason, [MarshalAs(UnmanagedType.BStr)] string disconnectErrorMessage);
        [PreserveSig] [DispId(754)] void OnStatusChanged(int statusCode, [MarshalAs(UnmanagedType.BStr)] string statusMessage);
        [PreserveSig] [DispId(755)] void OnAutoReconnecting(int disconnectReason, int ExtendedDisconnectReason, [MarshalAs(UnmanagedType.BStr)] string disconnectErrorMessage, bool networkAvailable, int attemptCount, int maxAttemptCount);
        ...
        [PreserveSig] [DispId(760)] void OnAdminMessageReceived([MarshalAs(UnmanagedType.BStr)] string adminMessage);
    ...
    {
        #region IMsRdpDevice
        [DispId(222)] string DeviceInstanceId { [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(220)] string FriendlyName { [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(221)] string DeviceDescription { [return: MarshalAs(UnmanagedType.BStr)] get; }
    ...
    {
        #region IMsRdpDrive
        [DispId(229)] string Name { [return: MarshalAs(UnmanagedType.BStr)] get; }
    ...
    public interface IMsRdpCameraRedirConfig
    {
        ...
        [DispId(1)] string FriendlyName { [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(2)] string SymbolicLink { [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(3)] string InstanceId { [return: MarshalAs(UnmanagedType.BStr)] get; }
        [DispId(4)] string ParentInstanceId { [return: MarshalAs(UnmanagedType.BStr)] get; }
